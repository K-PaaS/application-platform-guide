...
## <div id='1.2'/>1.2. 범위
K-PaaS AP는 bosh-deployment를 기반으로 한 BOSH 환경에서 설치하며 ap-deployment v5.8.8.1의 설치를 기준으로 가이드를 작성하였다.  
K-PaaS AP는 VMware vSphere, Google Cloud Platform, Amazon Web Services EC2, OpenStack, Microsoft Azure 등의 IaaS를 지원하며,  ap-deployment v5.8.8.1에서 검증한 IaaS 환경은 OpenStack, vSphere 환경이다.
...
ap-deployment v5.8.8.1은 Ubuntu jammy stemcell 1.181을 기반으로 한다.  
