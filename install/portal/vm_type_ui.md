...
- Portal Deployment Git Repository URL : https://github.com/K-PaaS/portal-deployment/tree/v5.2.27
...
# Deployment 파일 다운로드
$ git clone https://github.com/K-PaaS/portal-deployment.git -b v5.2.27
```
