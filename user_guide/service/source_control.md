...
3. [형상관리 사용자 포탈 서비스](#6)
     ...
     * [3.1.3.1.6.1. 레파지토리 브랜치 목록 조회](#23)
...
3.	사용할 이메일 계정과 비밀번호를 입력하고, “SIGN IN” 버튼을 클릭한다.  
![004]
...
![016]
    ...
    또는, 레파지토리 참여자 권한 추가와 같은 방식으로, [소스 컨트롤러 사용자 검색] 안에서 참여자 권한 삭제할 사용자를 입력한다. 사용자 검색 목록에서 사용자를 확인 후, “-” 아이콘을 클릭한다.  
![013]
...
2.	레파지토리를 생성한 모든 참여자들의 리스트가 확인된다. 페이지 화면 맨 오른쪽에 있는 사용/정지 이미지로 형상관리의 사용여부를, 소유자/쓰기/보기의 이미지로 레파지토리 참여자 권한을 확인할 수 있다.  
![017]
...
1.	레파지토리 상세보기 페이지의 탭 첫 번째 왼쪽의 “파일(file)”을 클릭하면 브랜치, 태그, 참여자에 대한 정보 확인이 가능하다.  
![034]
...
### <div id='23'/> 3.1.3.1.6.1. 레파지토리 브랜치 목록 조회
