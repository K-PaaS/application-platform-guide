...
***※ 빌드 Job 구성 조회는 파이프라인 참여자면 모두 가능하다. 하지만 수정은 관리자와 파이프라인 참여자 중 생성 권한을 가진 참여자만 가능하다.***
...
***※	테스트 Job 구성 조회는 파이프라인 참여자면 모두 가능하다. 하지만 수정은 관리자와 파이프라인 참여자 중 생성 권한을 가진 참여자만 가능하다.***
