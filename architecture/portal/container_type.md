### [Index](https://github.com/K-PaaS/Guide/blob/master/README.md) > [AP Architecture](../README.md) > Portal Container Type
...
Portal Infra는 BOSH로 배포되고, Portal APP은 K-PaaS AP로 배포된다.  
